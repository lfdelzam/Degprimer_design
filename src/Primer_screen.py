...
#usage = 'Primer_screen.py -d -o -c -g -t'
...
parser.add_argument(
    '-d', dest='d', help='input directory, degeprime output *_selected', required=True)
parser.add_argument(
    '-o', dest='o', help='output file, list of selected primers', required=True)
parser.add_argument(
    '-c', dest='c', help='coverage threshold, fraction, default 0.99', default=0.99)
parser.add_argument(
    '-g', dest='g', help='gc content threshold, in percentage, default 33', default=33)
#parser.add_argument(
